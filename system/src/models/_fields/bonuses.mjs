...
export const bonuses = () =>
	new fields.SchemaField({
		acBonus: new fields.NumberField({ integer: true, initial: 0}),
		...
		gearSlots: new fields.NumberField({ integer: true, initial: 0}),
		hauler: new fields.BooleanField({initial: false}),
		lightSource: new fields.StringField(),
		meleeAttackBonus: new fields.NumberField({ integer: true, initial: 0}),
		meleeDamageBonus: new fields.NumberField({ integer: true, initial: 0}),
		rangedAttackBonus: new fields.NumberField({ integer: true, initial: 0}),
		rangedDamageBonus: new fields.NumberField({ integer: true, initial: 0}),
		spellcastingCheckBonus: new fields.NumberField({ integer: true, initial: 0}),
		spellcastingClasses: new fields.ArrayField(new fields.StringField()),
		stoneSkinTalent: new fields.NumberField({ integer: true, initial: 0}),
		unarmoredAcBonus: new fields.NumberField({ integer: true, initial: 0}),
