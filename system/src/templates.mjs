export default function() {
	const partials = [
		...
		"systems/shadowdark/templates/items/partials/magic-active-effects.hbs",
		"systems/shadowdark/templates/items/partials/magic-item.hbs",
		...
		"systems/shadowdark/templates/partials/details/description.hbs",
